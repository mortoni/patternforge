...
function AppShellInner({
  ...
  return (
    <div
      className={cn(
        "flex pf-app-shell-root min-h-0 w-full min-w-0 max-w-full overflow-hidden bg-[var(--background)]",
    ...
    >
      ...
      {mode === "hidden" && !overlayOpen && (
        <button
          ...
          className="pointer-events-none fixed left-[calc(1.5rem+var(--safe-area-left))] top-[calc(1.5rem+var(--safe-area-top))] z-50 hidden h-10 w-10 items-center justify-center rounded-md border border-[var(--border)] bg-[var(--background)]/90 text-muted-foreground shadow-sm backdrop-blur transition-colors hover:bg-[var(--muted)] hover:text-[var(--foreground)] md:pointer-events-auto md:inline-flex"
        >
      ...
      {!isTrainingFocus && (
        <ThemeToggle className="fixed right-[calc(1.5rem+var(--safe-area-right))] top-[calc(1.25rem+var(--safe-area-top))] z-50 hidden border border-[var(--border)] bg-[var(--background)]/90 backdrop-blur transition-colors hover:bg-[var(--muted)] md:inline-flex" />
      )}
    </div>
  );
}
...
function OverlaySidebar({
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <aside
        className={cn(
          "absolute left-0 top-0 flex h-full min-h-0 flex-col overflow-hidden border-r border-[var(--border)] bg-[var(--background)] transition-[width,transform] duration-200 pf-site-header",
